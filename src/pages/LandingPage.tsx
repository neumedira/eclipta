          ...
          <Row className="align-items-center justify-content-between">
            ...
            <Col md={8}>
              <div className="bg-body p-4 rounded-3 shadow-sm">
                <h1 className="display-5 fw-bold bg-text mb-2">
                  {about.fullName}
                </h1>
                <h2 className="h4 text-primary mb-3">
                  {about.job} at {about.workplace}
                </h2>
                    ...
                    <Row className="text-center g-2">
                      {about.techStack.map((tech, index) => (
                        <Col key={index} xs={6} sm={2} md={2} className="mb-1">
                          <div
                            className="tech-card p-3 rounded-3"
            ...
            <Col lg={6} className="mb-4 mb-lg-0">
              ...
              {about.experiences
                ...
                .map((exp) => (
                  <Card
                    key={exp.id}
                    className="mb-4 border-0 shadow-md hover-card"
                  >
                    <Card.Body className="p-4">
                      ...
                      <p className="small text-muted mb-3 d-flex align-items-center">
                        ...
                        {formatDateIndonesian(exp.startDate)} -{" "}
                        {exp.endDate && !isNaN(new Date(exp.endDate).getTime())
                          ? formatDateIndonesian(exp.endDate)
                          : "Sekarang"}
                      </p>
                      <div
                        className="mb-0"
                  ...
                  >
                    <Card.Body className="p-4">
                      ...
                      <p className="small text-muted mb-0 d-flex align-items-center">
                        <Calendar size={16} className="me-2" />
                        {formatDateIndonesian(edu.startDate)} -{" "}
                        {edu.endDate && !isNaN(new Date(edu.endDate).getTime())
                          ? formatDateIndonesian(edu.endDate)
                          : "Sekarang"}
                      </p>
                    </Card.Body>
                  </Card>
                    ...
                    <Card.Body className="p-4">
                      ...
                      <Card.Text className="text-muted small d-flex align-items-center">
                        ...
                        !isNaN(new Date(project.endDate).getTime())
                          ? formatDateIndonesian(project.endDate, "short")
                          : "Sekarang"}
                      </Card.Text>
                      <Card.Text
                        className="mb-3"
                      ...
                      {post.image ? (
                        ...
                        <div
                          style={{
                            ...
                            width: "100%",
                            background:
                              "linear-gradient(45deg, #f0f0f0, #fafafa)",
                            display: "flex",
                            alignItems: "center",
                            justifyContent: "center",
                            color: "#666",
                      ...
                      <div className="mb-3">
                        {post.tags.map((tag, index) => (
                          <Badge
                            ...
                            bg="warning"
                            text="dark"
                            className="me-1 mb-1 py-2 px-3 rounded-pill"
                          >
                            {tag}
                          </Badge>
                        ))}
